...
public class Sucursales extends RecyclerView.Adapter<Sucursales.ViewHolder> {
    ...
    public void update(ArrayList<Sucursal> sucursales) {
        this.dataset.addAll(sucursales);
    ...
    public void onBindViewHolder(@NonNull ViewHolder viewHolder, int i) {
        //Adding bottom reached listener
//        if (i == 1 ) {
...
//        if (!sucursal.getLatitud().equals("") && !sucursal.getLongitud().equals("")) {
...
//        viewHolder.rbCalificacion.setRating((float)sucursal.getCalificacion());
        ...
        if (sucursal.getNumExt()!=null) {
            if (!sucursal.getNumExt().equals("None") && !sucursal.getNumExt().equals("")) {
                viewHolder.tvSucursalDireccion.setText(sucursal.getCalle()+" "+sucursal.getNumExt()+" "+sucursal.getColonia()+" "+sucursal.getMunicipio());
            }
        }
        if (sucursal.getNumInt()!=null) {
            if (!sucursal.getNumInt().equals("None") && !sucursal.getNumInt().equals("")) {
...
//                        Glide.with((context).getApplicationContext()).applyDefaultRequestOptions(RequestOptions.noTransformation().diskCacheStrategy(DiskCacheStrategy.ALL)).load(club.getFoto()).into(viewHolder.ivImagenSucursal);
//                    } else {
