...
public class EvaluarDiario extends Fragment {
    ...
    Button btnEvaluear;
    int calificacion = 0;
    public static EvaluarDiario newInstance() {
        EvaluarDiario fragment = new EvaluarDiario();
        return fragment;
    }
                                        ...
                                        public void onResponse(Call<PromedioEvaluacion> call, Response<PromedioEvaluacion> response) {
                                            ...
                                            if (response.isSuccessful()) {
                                                ...
                                                if (fragmentManager.findFragmentByTag("CLUBDETALLE")==null) {
                                                    ...
                                                    bundle.putInt(Variables.SUCURSAL_ID, idSucursal);
...
//                    fragmentTransaction.setCustomAnimations(R.anim.enter_from_right,R.anim.exit_to_right,R.anim.enter_from_right,R.anim.exit_to_right);
                                                    ...
                                                    Toast.makeText(getActivity(), "Tus sesiones se han agotado. Te invitamos a adquirir un nuevo plan.", Toast.LENGTH_SHORT).show();
                                                }
                                            } else {
                                            }
                                        }
