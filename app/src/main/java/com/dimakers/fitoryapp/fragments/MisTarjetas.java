...
import com.dimakers.fitoryapp.adapters.Horarios;
...
public class MisTarjetas extends Fragment {
    ...
    public static MisTarjetas newInstance(){
        MisTarjetas tarjetas = new MisTarjetas();
        return tarjetas;
    }
