...
public class SuscripcionGratisDetalle extends Fragment {
    ...
    public static SuscripcionGratisDetalle newInstance() {
        SuscripcionGratisDetalle misSuscripciones = new SuscripcionGratisDetalle();
        return misSuscripciones;
    }
    SharedPreferences sharedPreferences;
    SharedPreferences.Editor editor;
    TextView tvSuscripcionTipo, tvSuscripcionSesiones, tvSuscripcionPrecio, tvSuscripcionSesionesRestantes, tvSuscripcionComoLlegar, tvSuscripcionDireccion, tvSuscripcionTelefono, tvSuscripcionCorreo, tvSuscripcionHorario;
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            SubscripcionesGratis subscripcionGratis = (SubscripcionesGratis) bundle.getSerializable(Variables.SUSCRIPCION);
            Call<Visita> visitaCall = service.obtenerVisitas(subscripcionGratis.getSucursal(),subscripcionGratis.getCliente());
...
//            tvSuscripcionSesionesRestantes.setText("Sesiones Restantes: "+suscripcion.getSesion().getSesionesRestantes());
            tvSuscripcionPrecio.setText("GRATIS");
            tvSuscripcionSesionesRestantes.setText(subscripcionGratis.getFechaFin());
            ...
            //Detalles del club
            tvSuscripcionDireccion.setText(subscripcionGratis.getSucursalDireccion());
            tvSuscripcionTelefono.setText(subscripcionGratis.getSucursalTelefono());
            tvSuscripcionCorreo.setText(subscripcionGratis.getSucursalCorreo());

            Call<PerfilSucursal> perfilSucursalCall = service.obtenerPerfilSucursal(subscripcionGratis.getSucursal(),subscripcionGratis.getCliente());
...
//        adapter.update(suscripcions);
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_suscripcion_gratis_detalle,container,false);
    }
